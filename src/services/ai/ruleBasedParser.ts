...
export const BENCHMARK_ARCHETYPES: BenchmarkArchetype[] = [
  {
    ...
    estimatedStartupCost: 4500, // Outillage de mesure, EPI, décennale, stage/formalités, communication
    estimatedMonthlyCost: 350, // Assurance décennale, carburant, expert-comptable
    estimatedRevenue: 3200,
    rampUpMonths: 2,
    minimumSafetyBuffer: 1500,
    typicalRisks: [
  ...
  },
  {
    ...
    estimatedStartupCost: 22000,
    estimatedMonthlyCost: 1200,
    estimatedRevenue: 4500,
    rampUpMonths: 3,
    minimumSafetyBuffer: 3000,
    typicalRisks: [
  ...
  },
  {
    ...
    estimatedStartupCost: 45000,
    estimatedMonthlyCost: 4000,
    estimatedRevenue: 12000,
    rampUpMonths: 5,
    minimumSafetyBuffer: 6000,
    typicalRisks: [
  ...
  },
  {
    ...
    estimatedStartupCost: 3500,
    estimatedMonthlyCost: 400,
    estimatedRevenue: 2200,
    rampUpMonths: 4,
    minimumSafetyBuffer: 1000,
    typicalRisks: [
  ...
  },
  {
    ...
    estimatedStartupCost: 25000, // Apport + frais notaire
    estimatedMonthlyCost: 1100, // Mensualité crédit + charges
    estimatedRevenue: 0,
    rampUpMonths: 2,
    minimumSafetyBuffer: 5000,
    typicalRisks: [
