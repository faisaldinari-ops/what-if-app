...
export const BENCHMARK_ARCHETYPES: BenchmarkArchetype[] = [
  ...
  },
  {
    ...
    estimatedStartupCost: 16000,
    estimatedMonthlyCost: 1600,
    estimatedRevenue: 4000,
    rampUpMonths: 4,
    minimumSafetyBuffer: 4500,
    typicalRisks: [
  ...
  },
  {
    ...
    estimatedStartupCost: 6000,
    estimatedMonthlyCost: 1500,
    estimatedRevenue: 2800,
    rampUpMonths: 6,
    minimumSafetyBuffer: 3500,
    typicalRisks: [
